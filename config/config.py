...
API_ID = int(getenv("API_ID", "26118543"))

API_HASH = getenv("API_HASH", "a66f3d59bf3379800b8efaefc0f2308b")


## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "7952622129:AAGvjwvj_9DQbgdzneEqnCjJTNaUv86tvUw")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002300410678"))


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7573273095").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/Deep_XD"
)

SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/offIine_xd"
)  
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/mobashirahmad569-cyber/VenomMusic")
